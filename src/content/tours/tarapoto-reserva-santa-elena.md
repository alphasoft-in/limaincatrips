...
<div class="mb-8">
  <p class="text-lg text-gray-700 leading-relaxed">
    ...
    Prepárate para una aventura de Full Day en la que nosotros nos encargaremos de todo para que tú solo te dediques a disfrutar y crear recuerdos inolvidables.
  </p>
</div>
