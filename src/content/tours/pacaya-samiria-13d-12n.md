...
<div class="mb-8">
  <p class="text-lg text-gray-700 leading-relaxed">
    ...
    Prepárate para una aventura de 13D / 12N en la que nosotros nos encargaremos de todo para que tú solo te dediques a disfrutar y crear recuerdos inolvidables.
  </p>
</div>
...
<div class="space-y-6">
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 7: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 8: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 9: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 10: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 11: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 12: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
  ...
  <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
    <div class="flex items-center gap-4 mb-4">
      ...
      <h3 class="text-xl font-bold text-gray-900">Día 13: Actividades programadas</h3>
    </div>
    <p class="text-gray-600 mb-4">Recepción, instalación en el alojamiento y comienzo de nuestras excursiones por la región. Disfrutaremos de paisajes increíbles, cultura local y deliciosa gastronomía.</p>
    <div class="bg-gray-50 rounded-lg p-4">
      <h4 class="font-bold text-brand-primary mb-2 text-sm uppercase">Alimentación incluida:</h4>
